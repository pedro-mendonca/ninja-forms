			...
			<div class="nf-field-body">
				<div class="nf-field-sidebar">
					<ul class="nf-field-tabs">
						...
						<li class="nf-field-tab">Basic</li>
						<li class="nf-field-tab active">Restrictions</li>
						<li class="nf-field-tab">Calculations</li>
						<li class="nf-field-tab">Advanced</li>
						<li class="nf-field-tab">Conditionals</li>
						<li class="nf-field-tab">Styles</li>
					</ul>
				</div>
				<div class="nf-field-content">
					<div class="inside">
						<dl class="nf-field-settings checkbox-input">
							<dt>
								<label for="nf-required">Required</label>
							</dt>
							<dd>
								<input type="checkbox" id="nf-required" value="1">
								<span class="nf-desc">This field must be completed for form to submit.</span>
							</dd>
						</dl>
						<dl class="nf-field-settings select">
							<dt>
								<label for="nf-mask">Input Format</label>
							</dt>
							<dd>
								<select id="nf-mask">
									<option>None</option>
								...
								<input type="text" placeholder="999-99-9999" />
								<span class="nf-desc">This will force user input into a specific format.</span>
							</dd>
						</dl>
					</div>
				</div>
