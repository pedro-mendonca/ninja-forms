<?php
/**
 * Main Actions Class (The term Notifications is currently being changed to Actions)
 *
...
class NF_Notifications
{
	...
	function __construct() {
		...
		// Include our base action type
		require_once( NF_PLUGIN_DIR . 'classes/actions/types/base-type.php' );

		// Register our notification types
		Ninja_Forms()->notification_types['email'] = require_once( NF_PLUGIN_DIR . 'classes/actions/types/email.php' );
		Ninja_Forms()->notification_types['redirect'] = require_once( NF_PLUGIN_DIR . 'classes/actions/types/redirect.php' );
		Ninja_Forms()->notification_types['success_message'] = require_once( NF_PLUGIN_DIR . 'classes/actions/types/success-message.php' );
